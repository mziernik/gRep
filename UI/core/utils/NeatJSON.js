export default function neatJSON(value, opts) {
    opts = opts || {}
    ...
    function rawBuild(o, indent) {
        if (o === null || o === undefined) return indent + 'null';
            ...
            if (typeof o === 'number') {
                ...
                if (sort) sortedKV = sortedKV.sort(function (a, b) {
                    a = a[2];
                    b = b[2];
                    return a < b ? -1 : a > b ? 1 : 0
                });
                var keyvals = sortedKV.map(function (kv) {
                    return [JSON.stringify(kv[0]), build(kv[1], '')]
                });
                if (opts.sorted) keyvals = keyvals.sort(function (kv1, kv2) {
                    kv1 = kv1[0];
                    kv2 = kv2[0];
                    return kv1 < kv2 ? -1 : kv1 > kv2 ? 1 : 0
                });
                keyvals = keyvals.map(function (kv) {
                    return kv.join(colon1)
                }).join(comma);
                ...
                if (opts.short) {
                    ...
                    if (sort) keyvals = keyvals.sort(function (a, b) {
                        a = a[2];
                        b = b[2];
                        return a < b ? -1 : a > b ? 1 : 0
                    });
