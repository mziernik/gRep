...
public class RElement extends Repository<Integer> {

    public final static Column<Integer> ID = new Column<>(c -> {
        c.repository = RElement.class;
        c.type = DataType.INT;
        c.required = true;
    ...
    public final static ForeignColumn<Integer, RElement> FOREIGN_ELM = new ForeignColumn<>(c -> {
        c.repository = RElement.class;
        c.type = DataType.INT;
